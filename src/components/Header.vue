    ...
    <div class="container">
      <nav class="navbar navbar-light">
        <div class="dropdown d-xl-none d-lg-none mr-auto">
          <img src="@/assets/dropdown.png" data-toggle="dropdown" data-target="#navd" aria-haspopup="true"
            aria-expanded="false" width="40">
      ...
      <!--User Modal-->
      <!-- How ti work role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" -->
